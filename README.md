...
* Wallet: you have 2 options for wallet, create new wallet, import it in your metamask and mint base domain, or import your wallet that minted base domain with it before (submit private key without 0x)
